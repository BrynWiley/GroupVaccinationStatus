...
#setwd("./data")
temp <- tempfile()
githubURL <- ("https://raw.githubusercontent.com/BrynWiley/VaccinationStatus/master/vaccine_data.rds")
...
unlink(temp)
githubURL <- ("https://raw.githubusercontent.com/BrynWiley/VaccinationStatus/master/bad_locations.rds")
             ...
             tabPanel("Estimated Vaccination Rates",value="third",
                      ...
                      sidebarLayout(position="right",
                                    ...
                                    sidebarPanel = sidebarPanel(
                                      ...
                                      and they include approximations or estimations for past vaccination rates. (see Data Sources and Explanations for more information)."),
